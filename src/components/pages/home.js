...
export default function Home(props) {
    ...
    const getAllBooks = () => {
        axios.get('https://josh-hookstore-api.herokuapp.com/book/get')
        .then(res => {
    ...
    const renderBooks = () => {
        return allBooks.map(book => {
            return <div key={book.id}><Book book={book} handleEditClick={handleEditClick} handleDeleteClick={handleDeleteClick}/></div>
        })
    }
